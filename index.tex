...
\hypersetup{
  pdftitle={A manuscript template from the D3Mod using Quarto Manuscripts},
  pdfauthor={W. Alton Russell, PhD},
  pdfkeywords={Simulation, Data science},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{document}
\title{A manuscript template from the D3Mod using Quarto Manuscripts}

\authors{W. Alton Russell, PhD\affil{1}}
\affiliation{1}{McGill School of Population and Global Health, }
\correspondingauthor{W. Alton Russell, PhD}{alton.russell@mcgill.ca}
...
\textsubscript{Source:
\href{https://altonrus.github.io/quarto-manuscript-d3mod/index.qmd.html}{Article
Notebook}}
...
\textsubscript{Source:
\href{https://altonrus.github.io/quarto-manuscript-d3mod/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
